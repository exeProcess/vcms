    ...
    <section class="content">
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="number" id="spent" class="form-control">
              </div>
              <div class="form-group">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" id="submit" value="Create new Project" class="btn btn-success float-right">
        </div>
      </div>
    </section>
    <!-- /.content -->
